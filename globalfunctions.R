...
cell_type_w_o_mrema<- function(sum_exp_raw_count, raw.gs){
  n<- 1000
  m<- 1e-6
  iter<- 10
...
cell_type_wm_o_mrema<- function(sum_exp_raw_count, raw.gs){
  n<- 1000
  m<- 1e-6
  iter<- 10
...
cell_type_mrema<- function(sum_exp_raw_count, raw.gs){
  n<- 1000
  m<- 1e-6
  iter<- 10
